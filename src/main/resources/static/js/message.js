...
;(function(global,$){
	 ...
	 */
	 var cssMap={
		...
		'.toast-message--success':'{border-color:#67C23A;background-color:#f0f9eb;}',
		...
		'.toast-message--warning':'{border-color:#E6A23C;background-color:#fdf6ec;}',
		...
		'.toast-message--error':'{border-color:#F56C6C;background-color:#fef0f0;font-weight:bold;}',
